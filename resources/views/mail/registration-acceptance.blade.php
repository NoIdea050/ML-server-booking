                                ...
                                <tr>
                                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 13px; padding: 20px 5px;">
                                        <div class="f-fallback">
                                            <h1 style="margin-top: 0; color: #333333; background-color:#ebb1b7 font-size: 20px; font-weight: bold; text-align: center;" align="center">{{ $email_data['subject'] }}</h1>
                                            <p style="font-size: 14px; line-height: 14px; color: #51545E; margin: .4em 0 1.1875em; padding-bottom:10px;">
                                                Dear {{ $email_data['name'] }}, {{ $email_data['body'] }}.
                                            </p>
