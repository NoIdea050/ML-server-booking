                                        ...
                                        <div class="f-fallback">
                                            ...
                                            <table style="width: 100%; font-size:12px; line-height:12px; margin-top:15px; color:#51545e;">
                                                <tr style="background-color: #ddd;">
                                                    <th colspan="2" style="text-align: center;">Booking Information</th>
                                                </tr>
                                                <tr>
                                                    <th style="text-align: left;">Start Date & Time</th>
                                                    <td>{{ date('d-m-Y h:i a', strtotime($email_data['booking_data']->start_date_and_time)) }}</td>
                                                </tr>
                                                <tr>
                                                    <th style="text-align: left;">End Date & Time</th>
                                                    <td>{{ date('d-m-Y h:i a', strtotime($email_data['booking_data']->end_date_and_time)) }}</td>
                                                </tr>
                                                <tr>
                                                    <th style="text-align: left;">Type</th>
                                                    <td>{{ $email_data['booking_data']->type }}</td>
                                                </tr>
                                                <tr>
                                                    <th style="text-align: left;">Notes</th>
                                                    <td>{{ $email_data['booking_data']->note ? $email_data['booking_data']->note : '' }}</td>
                                                </tr>
                                                @if ($email_data['booking_data']->credit_cost)
                                                    <tr>
                                                        <th style="text-align: left;">Credit Cost</th>
                                                        <td>{{ $email_data['booking_data']->credit_cost }}</td>
                                                    </tr>
                                                @endif
                                                <tr>
