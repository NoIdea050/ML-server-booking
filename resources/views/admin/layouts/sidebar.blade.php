    ...
    <nav id="sidebar">
        <ul class="navbar-nav theme-brand flex-row text-center">
            ...
            <li class="nav-item theme-text">
                <a href="{{ route('admin.dashboard') }}" class="nav-link" style="font-size: 18px !important;">ML Server Booking</a>
            </li>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="#booking-management" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled" id="booking-management" data-parent="#accordionExample">
                    <li>
                        <a href="{{route($url_group.'.booking.index')}}"> Booking List </a>
                    </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="user" data-parent="#accordionExample">
                    <li>
                        <a href="{{route($url_group.'.user.index')}}"> User List</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                <a href="#storage" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled" id="storage" data-parent="#accordionExample">
                    <li>
                        <a href="{{route($url_group.'.storage.index')}}"> Storage List</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="setting" data-parent="#accordionExample">
                    <li>
                        <a href="{{ route($url_group.'.system.settings') }}"> System Setting </a>
                    </li>
                </ul>
            </li>
        </ul>
