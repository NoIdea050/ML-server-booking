                        ...
                        <div class="widget-content widget-content-area">
                            <div class="row page-title-wrapper">
                                <div class="col-sm-12 col-md-2">
                                    <a href="{{ route($url_group.'.user.credit-history', $data->user_info->id) }}"
                                ...
                                <div class="col-10 col-sm-10 col-md-8 title-wrapper">
                                    <h3 class="text-center title">Add New Credit to {{ $data->user_info->name }}</h3>
                                </div>
                                <div class="col-1 col-sm-1 col-md-1 refresh-btn-wrapper">
                                    <a href="{{ route($url_group.'.credit-history.edit', $data->id) }}"
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-12 col-md-8 py-4">
                                    <form action="{{ route($url_group.'.credit-history.update', $data->id) }}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="row mt-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="name" value="{{ $data->user_info->name }}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="email"
                                                            ...
                                                            name="email" value="{{ $data->user_info->email }}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="datetime-local"
                                                            ...
                                                            name="date_and_time" value="{{ $data->date_and_time ? $data->date_and_time : date('Y-m-d\TH:i:s') }}">
                                                    </div>
                                                </div>
                                            </div>
