                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-12 col-md-8 py-4">
                                    <form action="{{ route($url_group.'.storage.store') }}" method="post">
                                        @csrf
                                        <div class="row mt-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="title" value="{{ old('title') }}" placeholder="Enter Resource Title(Ex: CPU1/GPU1)">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="cost_per_hour" value="{{ old('cost_per_hour') }}" placeholder="Enter Credit Cost(Per Hour)">
                                                    </div>
                                                </div>
                                            </div>
